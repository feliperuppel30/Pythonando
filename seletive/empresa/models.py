...
class Empresa(models.Model):
    ...
    caracteristica_empresa = models.TextField(max_length=3000)
...
class Vagas(models.Model):
    ...
    nivel_experiencia = models.CharField(max_length=2, choices = choices_experiencias )
